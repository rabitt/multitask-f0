...
def model_def():
    ...
    y1 = Conv2D(64, (5, 5), padding='same', activation='relu', name='bendy1')(y0)
    y1a = BatchNormalization()(y1)
    y2 = Conv2D(8, (360, 1), padding='same', activation='relu', name='distribution')(y1a)
    y2a = BatchNormalization()(y2)
    y3 = Conv2D(16, (60, 3), padding='same', activation='relu', name='deharm')(y2a)
    y3a = BatchNormalization()(y3)
    y4 = Conv2D(64, (5, 5), padding='same', activation='relu', name='bendy2')(y3a)
    y4a = BatchNormalization()(y4)
    y5 = Conv2D(64, (3, 3), padding='same', activation='relu', name='smoothy1')(y4a)
    y5a = BatchNormalization()(y5)
    y6 = Conv2D(64, (3, 3), padding='same', activation='relu', name='smoothy2')(y5a)
