...
def get_model():
    ...
    y_vocal_feat4 = Conv2D(
        16, (7, 7), padding='same', activation='relu', name='vocal_filters4')(y_vocal_feat3)
    ...
    model = Model(inputs=y0, outputs=[multif0, vocal])
...
model = get_model()
output_path = '../../experiment_output/multitask_mf0_vocal'
tasks = ['multif0', 'vocal']
data_types = None
loss_weights = {'multif0': 2.0, 'vocal': 1.0}
sample_weight_mode = {'multif0': None, 'vocal': None}
task_indices = {'multif0': 0, 'vocal': 1}
