...
data_types = None
loss_weights = {
    'multif0': 2.0, 'melody': 1.0, 'bass': 1.0, 'vocal': 1.0, 'piano': 1.0, 'guitar': 1.0}
sample_weight_mode = {
    'multif0': None, 'melody': None, 'bass': None, 'vocal': None, 'piano': None, 'guitar': None}
task_indices = {'multif0': 0, 'melody': 1, 'bass': 2, 'vocal': 3, 'piano': 4, 'guitar': 5}
