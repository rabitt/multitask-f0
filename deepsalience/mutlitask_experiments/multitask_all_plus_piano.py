...
def get_model():
    ...
    model = Model(inputs=y0, outputs=[multif0, melody, bass, vocal, piano])
...
model = get_model()
output_path = '../../experiment_output/multitask_all_plus_piano'
tasks = ['multif0', 'melody', 'bass', 'vocal', 'piano']
data_types = None
loss_weights = {
    'multif0': 2.0, 'melody': 1.0, 'bass': 1.0, 'vocal': 1.0, 'piano': 1.0}
sample_weight_mode = {
    'multif0': None, 'melody': None, 'bass': None, 'vocal': None, 'piano': None}
task_indices = {'multif0': 0, 'melody': 1, 'bass': 2, 'vocal': 3, 'piano': 4}
