...
def get_model():
    ...
    model = Model(inputs=y0, outputs=[multif0, melody])
...
model = get_model()
output_path = '../../experiment_output/multitask_mf0_melody'
tasks = ['multif0', 'melody']
data_types = None
loss_weights = {'multif0': 2.0, 'melody': 1.0}
sample_weight_mode = {'multif0': None, 'melody': None}
task_indices = {'multif0': 0, 'melody': 1}
