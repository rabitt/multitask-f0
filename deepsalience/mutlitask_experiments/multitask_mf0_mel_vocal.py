...
def get_model():
    ...
    model = Model(inputs=y0, outputs=[multif0, melody, vocal])
...
model = get_model()
output_path = '../../experiment_output/multitask_mf0_mel_vocal'
tasks = ['multif0', 'melody', 'vocal']
data_types = None
loss_weights = {'multif0': 2.0, 'melody': 1.0, 'vocal': 1.0}
sample_weight_mode = {'multif0': None, 'melody': None, 'vocal': None}
task_indices = {'multif0': 0, 'melody': 1, 'vocal': 2}
