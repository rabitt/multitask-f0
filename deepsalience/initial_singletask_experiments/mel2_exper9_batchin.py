...
def model_def():
    ...
    y3 = Conv2D(8, (70, 3), padding='same', activation='relu', name='harmonics')(y2a)
    y3a = BatchNormalization()(y3)
    y4 = Conv2D(64, (3, 3), padding='same', activation='relu', name='smoothy1')(y3a)
    y4a = BatchNormalization()(y4)
    y5 = Conv2D(64, (3, 3), padding='same', activation='relu', name='smoothy2')(y4a)
    y5a = BatchNormalization()(y5)
    y6 = Conv2D(8, (360, 1), padding='same', activation='relu', name='distribution')(y5a)
