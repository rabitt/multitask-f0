...
def model_def():
    ...
    y1 = Conv2D(64, (3, 3), padding='same', activation='relu', name='bendy1')(inputs)
    y1a = BatchNormalization()(y1)
    y2 = Conv2D(64, (3, 3), padding='same', activation='relu', name='harmonics')(y1a)
    y2a = BatchNormalization()(y2)
    y3 = Conv2D(64, (3, 10), padding='same', activation='relu', name='temporal')(y2a)
